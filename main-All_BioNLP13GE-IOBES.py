...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/All_BioNLP13GE-IOBES.json')     
    parser.add_argument('--save_path', type=str, default='./All_BioNLP13GE-IOBES.pt')
    parser.add_argument('--predict_path', type=str, default='./All_BioNLP13GE-IOBES.json')
