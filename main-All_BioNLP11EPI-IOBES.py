...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/All_BioNLP11EPI-IOBES.json')      
    parser.add_argument('--save_path', type=str, default='./All_BioNLP11EPI-IOBES.pt')
    parser.add_argument('--predict_path', type=str, default='./All_BioNLP11EPI-IOBES.json')
    ...
    parser.add_argument('--att_redim', type=int)
    parser.add_argument('--att_hidden_dim', type=int)
