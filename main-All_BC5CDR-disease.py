...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/All_BC5CDR-disease.json')      
    parser.add_argument('--save_path', type=str, default='./All_BC5CDR-disease.pt')
    parser.add_argument('--predict_path', type=str, default='./All_BC5CDR-disease.json')
